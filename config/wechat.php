...
//     */
//    'app_id'  => env('WECHAT_APPID', 'xxxxxxxxxxxxxx'),         // AppID
//    'secret'  => env('WECHAT_SECRET', 'xxxxxxxxxxxxxx'),     // AppSecret
//    'token'   => env('WECHAT_TOKEN', 'xxxxxxxxxxxxxx'),          // Token
//    'aes_key' => env('WECHAT_AES_KEY', 'xxxxxxxxxxxxxx'),                    // EncodingAESKey
