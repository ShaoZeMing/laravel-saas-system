...
class CreateWorkerBillsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('worker_bills', function(Blueprint $table) {
            $table->bigInteger('id');
            $table->bigInteger('worker_id')->default(0)->comment('关联ID')->index();
