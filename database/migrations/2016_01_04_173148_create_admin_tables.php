...
class CreateAdminTables extends Migration
{
    ...
    public function up()
    {
        ...
        $sql = file_get_contents(database_path('admin_users.sql'));
        ...
        $sql = file_get_contents(database_path('admin_roles.sql'));
        \Illuminate\Support\Facades\DB::select($sql);
        ...
        $sql = file_get_contents(database_path('admin_permissions.sql'));
        \Illuminate\Support\Facades\DB::select($sql);
        ...
        $sql = file_get_contents(database_path('admin_menu.sql'));
        \Illuminate\Support\Facades\DB::select($sql);
        ...
        $sql = file_get_contents(database_path('admin_role_user.sql'));
        \Illuminate\Support\Facades\DB::select($sql);
        ...
        $sql = file_get_contents(database_path('admin_role_permissions.sql'));
        \Illuminate\Support\Facades\DB::select($sql);
        ...
        $sql = file_get_contents(database_path('admin_role_menu.sql'));
        \Illuminate\Support\Facades\DB::select($sql);
