...
class CreateSiteBillsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('site_bills', function(Blueprint $table) {
            $table->bigInteger('id');
            $table->bigInteger('site_id')->default(0)->comment('关联ID')->index();
