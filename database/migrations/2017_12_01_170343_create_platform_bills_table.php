...
class CreatePlatformBillsTable extends Migration
{
	...
	public function up()
	{
		Schema::create('platform_bills', function(Blueprint $table) {
            $table->bigInteger('id');
            $table->bigInteger('platform_id')->default(0)->comment('关联ID')->index();
